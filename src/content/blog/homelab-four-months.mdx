...
- I landed on a split design for my homelab. One miniPC runs kubernetes on Ubuntu Server and powers the data side of the homelab (obviously this needs more nodes, this is just for testing), and the other miniPC runs Proxmox and serves up traditional home server services.
</CalloutDisclaimer>
